            ...
            <div className={'grid grid-cols-1 md:grid-cols-2 gap-10'}>
                ...
                <div className={'space-y-5 flex justify-center flex-col xl:max-w-[500px]'}>
                    ...
                    <motion.p variants={SlideUp(0.4)} initial={'initial'} whileInView={'animate'} className={'text-gray-500 text-sm leading-7'}>
                        Create a stylish living room effortlessly with smart furniture choices, layered lighting, and a balanced color palette. Add texture with rugs, cushions, and décor. Incorporate statement pieces and greenery for a fresh, inviting look that reflects your personality.
                    </motion.p>
                ...
                <div className={'flex flex-col justify-center'}>
                    <motion.div initial={{x: 100, opacity: 0}} whileInView={{x: 0, opacity: 1}} transition={{duration: 0.5, delay: 0.5}}>
                        <Image src={'/assets/images/banner2.png'} alt={'banner2'} width={400} height={400} className={'w-[95%] md:w-full mx-auto'}/>
                    </motion.div>
                </div>
            </div>
        </div>
